...
<div class="history-styz-year">
  ...
  <div class="box">
    ...
    <div class="eco-realtime-data">
      ...
      <div class="choose">
        <div class="month" @click="gohistorystyzmonth()"><h4>月度总结</h4></div>
        <div class="year"><h4>年度总结</h4></div>
      </div>
    </div>
...
import {getOverSUmmaryYearChart,getEcoFactorYearChart,getEcoFactorYearTable,getOverCircleYearChart} from '../../api/huzhuApi.js'
export default {
  data(){
    return{
      allDataList:[
  ...
  methods:{
    ...
    gohistorystyzmonth(){
      this.$router.push('/realtime/history-styz-month')
    },
    getvalue(index,item){
    ...
    paintEcologicalFatorChart(i,name){
      ...
      $(".two-level-menu").slideUp(200);
      let data={time:this.year,name:name};
    ...
    pagechange(currentPage) {
      ...
      let data={time:this.year,likeName:this.likeName,currPage:currentPage,pageSize:this.display};
