      ...
      <figure>
          ...
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(6)">
              ...
              <div class="text-box-right3">
                ...
                <p style="letter-spacing:0px">人流监测</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage" v-show="positionContent[6].state" @mousedown="moveBox">
            ...
            <div class="punctuation-inner">
              <!-- <video src="img/bird.mp4" style="width:460px;height:310px" muted autoplay="autoplay" controls loop></video> -->
              <iframe src="http://120.253.72.183:10800/play.html?channel=5&iframe=yes&aspect=460x310" width="100%" height="100%" allowfullscreen allow="autoplay" scrolling="no"></iframe>
            </div>
          </div>
          ...
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="243" radius="246" @click="openInfo(7)">
              ...
              <div class="text-box-right3">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">车流入口</p>
              </div>
          </section>
          <div class="punctuation-content weather-machang-manage" v-show="positionContent[7].state" @mousedown="moveBox">
            ...
            <div class="punctuation-inner">
            <iframe src="http://120.253.72.183:10800/play.html?channel=3&iframe=yes&aspect=460x310" width="100%" height="100%" allowfullscreen allow="autoplay" scrolling="no"></iframe>
            <!-- <video src="img/bird.mp4" style="width:460px;height:310px" muted autoplay="autoplay" controls loop></video> -->
            </div>
          </div>
          ...
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="233" radius="275" @click="openInfo(8)">
              <div class="text-box-right3">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">车流出口</p>
              </div>
          </section>
          <div class="punctuation-content atmos-machang-manage" v-show="positionContent[8].state" @mousedown="moveBox">
            ...
            <div class="punctuation-inner">
              <iframe src="http://120.253.72.183:10800/play.html?channel=1&iframe=yes&aspect=460x310" width="100%" height="100%" allowfullscreen allow="autoplay" scrolling="no"></iframe>
              <!-- <video src="img/bird.mp4" style="width:460px;height:310px" muted autoplay="autoplay" controls loop></video> -->
            </div>
          </div>
...
export default {
  ...
  methods:{
    ...
    getWeather(){
      /* 获取天气 */
      $.get("http://wthrcdn.etouch.cn/weather_mini?city=漳县", function (data) {
        var info = data.data;
...
#ortho-box .ortho-point .text-box-right2 p{
  position: absolute;
  top:0px;
  left:0px;
  font-size:20px;
...
#ortho-box .ortho-point .text-box-right3 p{
  position: absolute;
  top:0px;
  left:0px;
  font-size:20px;
...
#ortho-box .ortho-point .right-top-high{
    left: 173px;top: 549px;
}
#ortho-box .ortho-point .type-icon-high{
  left: 212px;top: 524px;
}
