...
<div id="big">
  <div class="report" id="report">
    <div id="top"></div>
      <h1 class="report-title">漳县自然保护区鸟类多样性品种分析</h1>
      <h3 class="report-subtitle">简介</h3>
      <p class="report-shahu">甘肃漳县珍稀水生动物国家级自然保护区位于甘肃省定西市漳县境内，地处漳县漳河、龙川河、铁钩河、榜沙河等河流的山区，有大小支流20条，河流总长度274公里，总面积3775公顷。主要保护对象为国家Ⅱ级保护水生动物秦岭细鳞鲑等。保护区总面积3775公顷，其中：核心区1485公顷，占保护区总面积的39.34%，长度148公里；缓冲区1240公顷，占32.85%，长度71公里；实验区1050公顷，占27.81%，长度55公里，海拔1640-3941米。保护区地处秦岭、青藏高原和黄土高原的交接地带，是三大地槽结构的交接处，形成了保护区独特的自然生境，具有明显的第四纪早期古冰川残留遗迹。保护区海拔1640-3941米，总面积3775公顷，涉及漳河、龙川河、榜沙河“三河”流域,， 3条河流横贯全县9个乡（镇），县内流经长度131公里，流域面积达2164.4平方公里，多年平均径流量达5.6亿立方米。在动物区划中处于华北、蒙新、青藏、华中、西南五区交汇地带，是动物种类较为复杂的过渡区。由于地形、气候、水文、地质地貌、植被、土壤等自然环境复杂多样，形成了典型的生态结构较为原始的山地森林溪流型生态系统，成为国家重点保护动物秦岭细鳞鲑、水獭等多种珍稀水生野生动物的繁殖栖息地，尤其国家二级保护秦岭细鳞鲑是我国其资源分布最为集中的区域之一。</p>
      ...
      <div class="report-summary">
        ...
        <p v-if="hasData">
          在漳县珍稀水生动物国家自然保护区，于{{summaryList.time}}共监测到珍稀鸟类{{birdsList.length}}种，分别为 {{birdsList.toString()}},
          其中<span v-for="(item,index) in birdsList" :key="index">{{item}}出现频次峰值为{{maxList[index]}} 只，</span> 珍稀鸟类活动比较丰富，湿地生态多样性表现良好。
        </p>
        <p v-else>
          在漳县珍稀水生动物国家自然保护区，于{{summaryList.time}}共监测到珍稀鸟类0种。
        </p>
      </div>
