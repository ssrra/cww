...
<div id="big">
  <div class="report" id="report">
    <div id="top"></div>
      <h1 class="report-title">南泥湾国家湿地公园鸟类多样性品种分析</h1>
      <h3 class="report-subtitle">简介</h3>
      <p class="report-shahu">陕西延安南泥湾国家湿地公园位于陕西省延安市宝塔区，项目范围西起南泥湾收费站，沿汾川河向东至南泥湾镇镇界，北以303省道为界，南北方向沿河流至九龙泉、一连沟等主要范围内的河流、沼泽、库塘、人工稻田等水域及林地。湿地公园总面积1043.98公顷，湿地面积406.52公顷，湿地率为38.94%。湿地公园属高原大陆性季风气候，冬季寒冷干燥，维持期长；春季气温快升多变，易有霜冻，多大风、风沙、浮尘天气，常有春旱；夏季温热，雨量集中，间有伏旱，多雷阵雨天气，偶有冰雹；秋季气温速降，多雾，早霜出现，有阴雨天气。湿地公园现有脊椎动物5纲30目67科170属232种，其中鸟类132种，国家二级保护植物野大豆在公园范围内随处可见。</p>
      ...
      <div class="report-summary">
        ...
        <p v-if="hasData">
          在陕西南泥湾国家湿地公园，于{{summaryList.time}}共监测到珍稀鸟类{{birdsList.length}}种，分别为 {{birdsList.toString()}},
          其中<span v-for="(item,index) in birdsList" :key="index">{{item}}出现频次峰值为{{maxList[index]}} 只，</span> 珍稀鸟类活动比较丰富，湿地生态多样性表现良好。
        </p>
        <p v-else>
          在陕西南泥湾国家湿地公园，于{{summaryList.time}}共监测到珍稀鸟类0种。
        </p>
      </div>
