  ...
  <div class="bird">
      ...
      <div class="nav">
        <ul>
          <router-link to="/manage">
            <li class="first"><img src="../../public/img/huodong.png" alt=""><span>活动情况</span></li>
          </router-link>
    ...
    <div class="box">
      <div class="left">
        ...
        <div id="alert">
            <el-button class="button2" type="primary" round>时段拍摄统计</el-button>
            <div id="main"></div>
...
export default {
  data(){
    return{
      ...
      animal:[],// 所有动物种类
      radio: 10, // 动物种类index
      value: ['2020-01-01 00:00:00','2020-10-15 00:00:00'],// 开始时间与结束之间
        ...
        getAnimalsNum(data).then(res=>{
          ...
          for(let i = 0; i<res.data.length; i++){
            ...
            new ztmapgl.Marker([this.longitude[i],this.latitude[i]],
              ...
              smallBox.style.left = (param.domEvent.pageX - 15) + 'px';
              smallBox.style.top = (param.domEvent.pageY - 95) + 'px';
              // 查询当天物种活动情况
