<template>
  <div class="ecological-analyze">
    ...
    <!-- 视频 -->
    <div class="ecoanalyze-video">
      <div class="ecoanalyze-video-box">
...
// import {getOverSUmmaryChart,getEcoFactorChart,getEcoFactorTable,getOverCircleChart} from '@/api/axiosApi.js'
