<template>
  <div class="PictureHome">
    <div id="ortho-box">
      ...
      <figure>
          <img src="img/pictureHome/mapPicture1.png" />
          
           <!-- 野生动物1 top=0.2581-->
          <section class="ortho-point" point-left="0.3575" point-top="0.0781" degree="30" radius="160" @click="openInfo(0)">
              <img class="right-top-high" src="img/pictureHome/right-top.png" />
              <img class="type-icon-high" src="img/pictureHome/position.png" />
              <div class="text-box-right1">
                <img src="img/pictureHome/box-right-long.png">
                <p style="letter-spacing:0px">野生动物1</p>
              </div>
          </section>
          ...
          <!-- 野生动物2 0.39416-->
          <section class="ortho-point" point-left="0.60395" point-top="0.24416" degree="45" radius="110" @click="openInfo(1)">
              <img class="right-top-line" src="img/pictureHome/right-top.png" />
              <img class="type-icon" src="img/pictureHome/position.png" />
              <div class="text-box-right2">
          ...
          <div class="punctuation-content position-datai" v-show="positionContent[1].state" @mousedown="moveBox">
            ...
            <div class="punctuation-inner">
              <iframe src="http://120.253.72.183:10800/play.html?channel=24&iframe=yes&aspect=460x310'" width="100%" height="100%" allowfullscreen allow="autoplay" scrolling="no"></iframe>
          ...
          <!-- 气象 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="243" radius="246" @click="openInfo(2)">
              <img class="vertical-leftDown-90" src="img/pictureHome/right-top.png" />
              <img class="type-icon-vertical-leftDown-90" src="img/pictureHome/weather.png" />
              <div class="text-box-right3">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">气象监测</p>
              </div>
          </section>
          <div class="punctuation-content weather-machang-manage" v-show="positionContent[2].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
            <img src="img/pictureHome/close.png" alt="" class="close"  @click="closeInfo(2)">
            <div class="punctuation-inner">
              <p>气象监测</p>
          ...
          <!-- 土壤监测1 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(3)">
              <img class="vertical-leftDown" src="img/pictureHome/40.png" />
              <img class="type-icon-vertical-leftDown" src="img/pictureHome/soil.png" />
              <div class="text-box-right4">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">土壤监测1</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage" v-show="positionContent[3].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
            <img src="img/pictureHome/close.png" alt="" class="close"  @click="closeInfo(3)">
            <div class="punctuation-inner">
              <p>土壤监测1</p>
              <span v-for="(item,index) in turang" :key="index">{{item.name}}：{{item.value}}{{item.unit}}</span>
            </div>
          </div>

           <!-- 土壤监测2 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(4)">
              <img class="vertical-leftDown2" src="img/pictureHome/40.png" />
              <img class="type-icon-vertical-leftDown2" src="img/pictureHome/soil.png" />
              <div class="text-box-right5">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">土壤监测2</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage2" v-show="positionContent[4].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
           ...
           <!-- 土壤监测3 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(5)">
              <img class="vertical-leftDown3" src="img/pictureHome/right-top.png" />
              <img class="type-icon-vertical-leftDown3" src="img/pictureHome/soil.png" />
              <div class="text-box-right6">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">土壤监测3</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage3" v-show="positionContent[5].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
           ...
           <!-- 土壤监测4 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(6)">
              <img class="vertical-leftDown4" src="img/pictureHome/40.png" />
              <img class="type-icon-vertical-leftDown4" src="img/pictureHome/soil.png" />
              <div class="text-box-right7">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">土壤监测4</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage4" v-show="positionContent[6].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
           ...
           <!-- 土壤监测5 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(7)">
              <img class="vertical-leftDown5" src="img/pictureHome/line.png" />
              <img class="type-icon-vertical-leftDown5" src="img/pictureHome/soil.png" />
              <div class="text-box-right8">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">土壤监测5</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage5" v-show="positionContent[7].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
           ...
           <!-- 水质监测 -->
          <section class="ortho-point" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(8)">
              <img class="vertical-leftDown6" src="img/pictureHome/line.png" />
              <img class="type-icon-vertical-leftDown6" src="img/pictureHome/soil.png" />
              <div class="text-box-right9">
                <img src="img/pictureHome/box-left.png">
                <p style="letter-spacing:0px">水质监测</p>
              </div>
          </section>
          <div class="punctuation-content soil-machang-manage6" v-show="positionContent[8].state" @mousedown="moveBox">
            <img src="img/pictureHome/position.png" alt="" class="punctuation">
            <img src="img/pictureHome/close.png" alt="" class="close"  @click="closeInfo(8)">
            <div class="punctuation-inner">
              <p>水质监测</p>
              <span v-for="(item,index) in shuizhi" :key="index">{{item.name}}：{{item.value}}{{item.unit}}</span>
            </div>
          </div>
...
<script>
import {getEcologicalData} from '../api/huzhuApi.js'
export default {
  data(){
    return{
      displayExit:false,
  ...
  methods:{
      ...
      let data={id:id};
        ...
        if(id=="C0001"){
          ...
          for(let i=0;i<arr.length;i++){
            if(arr[i].name=="负氧离子"){
              fuyangBox.push(arr[i])
            }
          };
          console.log(fuyangBox);
          this.fuyang=fuyangBox;
          ///////////////////////////////
          for(let i=0;i<arr.length;i++){
            if(arr[i].name=="负氧离子"){
              arr.splice(i,1);
    ...
    getWeather(){
      /* 获取天气 */
      $.get("http://wthrcdn.etouch.cn/weather_mini?city=同心", function (data) {
        var info = data.data;
  ...
  mounted(){
    ...
    $(() => {
        ...
        if($(window).height()==1080){
          ...
          $.ortho({'boxWidth': 1920, 'boxHeight': 969, 'maxEdge': 5000, 'imgWidth': 1920, 'imgHeight': 2994});
        }
...
#ortho-box .ortho-point .text-box-right1{
  position:relative;
  top: 1497px;
  left: 286px;
}
#ortho-box .ortho-point .text-box-right2{
  position:relative;
  top: 154px;
  left: -1054px;
  z-index: 998;
}
#ortho-box .ortho-point .text-box-right3{
  position:relative;
  top: 373px;
  left: 610px;
}
#ortho-box .ortho-point .text-box-right4{
  position:relative;
  top: 635px;
  left: -199px;
  z-index: 998;
}
#ortho-box .ortho-point .text-box-right5{
  position:relative;
  top: 815px;
  left: 191px;
}
#ortho-box .ortho-point .text-box-right6{
  position:relative;
  top: 555px;
  left: 360px;
  z-index: 999;
}
#ortho-box .ortho-point .text-box-right7{
  position:relative;
  top: 415px;
  left: 182px;
}
#ortho-box .ortho-point .text-box-right8{
  position:relative;
  top: 670px;
  left: 363px;
}
#ortho-box .ortho-point .text-box-right9{
  position:relative;
  top: 830px;
  left: -308px;
}
...
#ortho-box .ortho-point .vertical-leftDown2{
    left: 304px;
    top: 776px;
}
#ortho-box .ortho-point .type-icon-vertical-leftDown2{
    left: 279px;
    top: 727px;
}
#ortho-box .ortho-point .vertical-leftDown3{
    left: 295px;
    top: 583px;
}
#ortho-box .ortho-point .type-icon-vertical-leftDown3{
    left: 271px;
    top: 620px;
}
#ortho-box .ortho-point .vertical-leftDown4{
    left: 292px;
    top: 467px;
}
#ortho-box .ortho-point .type-icon-vertical-leftDown4{
  left: 269px;
  top: 506px;
}
#ortho-box .ortho-point .vertical-leftDown5{
    left: 324px;
    top: 699px;
}
#ortho-box .ortho-point .type-icon-vertical-leftDown5{
   left: 275px;
  top: 675px;
}
#ortho-box .ortho-point .vertical-leftDown6{
    left: -86.729px;
    top: 850.928px;
}
#ortho-box .ortho-point .type-icon-vertical-leftDown6{
    left: -48.729px;
    top: 826.928px;
}
...
.soil-machang-manage2{
  left: 27.5%;
  top: 40.5%;
  z-index: 999;
}
.soil-machang-manage3{
  left: 54%;
  top: 30%;
  z-index: 999;
}
.soil-machang-manage4{
  left: 27%;
  top: 27.5%;
  z-index: 999;
}
.soil-machang-manage5{
  left: 47%;
  top: 36%;
  z-index: 999;
}
.soil-machang-manage6{
  left: 7%;
  top: 28%;
  z-index: 999;
}
