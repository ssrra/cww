  ...
  methods:{
    ...
    paintMap(){
      ...
      var marker1 = new ztmapgl.Marker(
        ...
        {
          'symbol' : {
            'markerFile'   : 'img/base/camera-botany.png',
            'markerWidth'  : 50,
            'markerHeight' : 50,
            'markerDx'     : 0,
            'markerDy'     : 0,
      ...
      function onEvent1(param) {
        events.push(param);
        var content = '<h3 style="margin-bottom:5px">样方地1</h3><iframe src="http://120.253.72.183:10800/play.html?channel=23&iframe=yes&aspect=640x360" width="640" height="360" allowfullscreen allow="autoplay" scrolling="no"></iframe>';
      ...
      function onEvent2(param) {
        events.push(param);
        var content = '<h3 style="margin-bottom:5px">样方地2</h3><iframe src="http://120.253.72.183:10800/play.html?channel=23&iframe=yes&aspect=640x360" width="640" height="360" allowfullscreen allow="autoplay" scrolling="no"></iframe>';
        console.log(document.getElementById("show-or-not"));
        document.getElementById("show-or-not").style.display="block";
        document.getElementById('events').innerHTML = '<div>' + content + '</div>';
        //return false to stop event propagation
      ...
      function onEvent(param) {
        events.push(param);
        var content = '<h3 style="margin-bottom:5px">样方地3</h3><iframe src="http://120.253.72.183:10800/play.html?channel=24&iframe=yes&aspect=640x360" width="640" height="360" allowfullscreen allow="autoplay" scrolling="no"></iframe>';
        console.log(document.getElementById("show-or-not"));
        document.getElementById("show-or-not").style.display="block";
        document.getElementById('events').innerHTML = '<div>' + content + '</div>';
        //return false to stop event propagation
