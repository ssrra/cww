      ...
      <div class="report" id="report">
        ...
        <h3 class="report-subtitle">
            ...
            <div class="month-input" >
              <el-date-picker
                @change="getReportDemo();getReportDemoTwo()"
                class="month-input"
                v-model="date"
                type="date"
                placeholder="选择日期"
            ...
            <!-- 监测点位 -->
            <el-select class="reportCaremaNum" v-model="value" @change="getReportDemo();getReportDemoTwo()">
              <el-option
...
export default {
   data(){
    return {
      ...
      imgurl:'http://192.168.20.103/' //测试地址
    }
  },
  methods:{
    goback(){
    ...
    //获取当天出现的鸟的种类
    getReportBirdFun(){
      let data={cameraNum:this.value,date:this.date};
    ...
    paintReportChart(){
      ...
      var option = {
        ...
        grid:{
              x:65,y:50,x2:50,y2:50,borderWidth:10,height: 300,width: 1455
	      },
        tooltip: {
            trigger: 'axis'
        },
...
　　    myChart.resize();
    ...
    paintReportChartTwo(){
      ...
      var Big = document.getElementById("report");
      // var Big = document.getElementsByClassName("box");
