...
/* 道路卡口模块 */
// 车流统计--年
export function getCarDataYear(data) {
  return request({
    method: 'post',
    headers: {
			'Content-Type': 'application/json; charset=UTF-8'
		},
    url: '/Traffic/findTrafficInfoByYear',
    params: data
  })
}
// 车流统计--月
export function getCarDataMonth(data) {
  return request({
    method: 'post',
    headers: {
			'Content-Type': 'application/json; charset=UTF-8'
		},
    url: '/Traffic/findTrafficInfoByMonth',
    params: data
  })
}
// 车流统计--日
export function getCarDataDay(data) {
  return request({
    method: 'post',
    headers: {
			'Content-Type': 'application/json; charset=UTF-8'
		},
    url: '/Traffic/findTrafficInfo',
    params: data
  })
}
// 车流统计--日--进入车辆
export function getCarDataDayIn(data) {
  return request({
    method: 'post',
    headers: {
			'Content-Type': 'application/json; charset=UTF-8'
		},
    url: '/Traffic/findCarIn',
    params: data
  })
}
// 车流统计--日--出去车辆
export function getCarDataDayOut(data) {
  return request({
    method: 'post',
    headers: {
			'Content-Type': 'application/json; charset=UTF-8'
		},
    url: '/Traffic/findCarOut',
    params: data
  })
}
