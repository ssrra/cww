...
<div id="big">
  <div class="report" id="report">
    <div id="top"></div>
      <h1 class="report-title">湖北竹山圣水湖鸟类多样性品种分析</h1>
      <h3 class="report-subtitle">简介</h3>
      <p class="report-shahu">湖北竹山圣水湖国家湿地公园位于湖北省十堰市竹山县上庸镇、溢水镇、潘口乡和深河乡交汇地带，距县城13公里，是潘口水电站建成后形成的人工库塘型湿地，总面积3255.2公顷，规划建设水上游乐园、观鸟台、多功能服务区、科学实验区等相关景点。公园内湿旱生动植物十分丰富。旱生植物有珍贵稀有“活化石、中国鸽子树、银杏、光叶珙桐、红豆杉、紫茎、山毛棒”等国家一、二级保护植植物9种，主要乔木有33科、68种，其中乡土树种50种，外地引进树种18种。经济林树种主要品种有油桐、生漆、板栗、核桃、肚倍、水棕、柑桔、油茶、茶叶、柿子、猕猴桃等。主要灌木树种有可供编织的杷柳，具有较高观赏价值的大叶黄杨、小叶黄杨，具有很好的绿肥使用的紫穗槐、胡枝子等。旱生动物有22目32科计120余种，湿生动物3科4属5种。湿生鸟类8科9属13种。其中国家重点保护的野生动物23种，省级重点保护野生动物26种。</p>
      ...
      <div class="report-summary">
        ...
        <p v-if="hasData">
          在湖北竹山圣水湖国家湿地公园，于{{summaryList}}共监测到珍稀鸟类{{birdsList.length}}种，分别为 {{birdsList.toString()}},
          其中<span v-for="(item,index) in birdsList" :key="index">{{item}}出现频次峰值为{{maxList[index]}} 只，</span> 珍稀鸟类活动比较丰富，湿地生态多样性表现良好。
        </p>
        <p v-else>
          在湖北竹山圣水湖国家湿地公园，于{{summaryList}}共监测到珍稀鸟类0种。
        </p>
      </div>
