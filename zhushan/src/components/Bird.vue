...
export default {
  data(){
    return{
      ...
      socketList:[{ws:'ws://192.168.250.103:8124',capIndex:1},{ws:'ws://192.168.250.103:8124',capIndex:2}],
      wsBirdList:[{name:'斑嘴鸭',count:10},{name:'绿头鸭',count:3},{name:'鹊鸭',count:12},{name:'斑嘴鸭',count:10},{name:'绿头鸭',count:3},{name:'鹊鸭',count:12},{name:'绿头鸭',count:3},{name:'鹊鸭',count:12}],
      ///////////////////////////////////////////
      date:'',//获取当天日期
      dataList:[],
