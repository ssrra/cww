<template>
  <div class="PictureHome">
    <div id="ortho-box">
      ...
      <figure > 
          <img src="img/pictureHome/fangxian.png" />
          
           <!-- 鸟类监测1 top=0.2581-->
          <section class="ortho-point" id="bird1" point-left="0.3575" point-top="0.0781" degree="30" radius="160" @click="openInfo(0)">
          ...
          <div class="punctuation-content all-manage-station" v-show="positionContent[0].state" @mousedown="moveBox">
            ...
            <div class="punctuation-inner">
              <iframe src="http://120.253.72.183:10800/play.html?channel=23&iframe=yes&aspect=460x310'" width="100%" height="100%" allowfullscreen allow="autoplay" scrolling="no"></iframe>
          ...
          <!-- 鸟类监测2 0.39416-->
          <section class="ortho-point" id="bird2" point-left="0.60395" point-top="0.24416" degree="45" radius="110" @click="openInfo(1)">
          ...
          <!-- 水文水质 -->
          <section class="ortho-point" id="water1" point-left="0.4825" point-top="0.40004" degree="275" radius="284" @click="openInfo(3)">
          ...
          <!-- 大气+气象+土壤 -->
          <section class="ortho-point" id="windy" point-left="0.3575" point-top="0.0988" degree="254" radius="229" @click="openInfo(6)">
          ...
          <section class="ortho-point" id="windy" point-left="0.3575" point-top="0.0988" degree="243" radius="246" @click="openInfo(7)">
          ...
          <section class="ortho-point" id="windy" point-left="0.3575" point-top="0.0988" degree="233" radius="275" @click="openInfo(8)">
...
export default {
  ...
  methods:{
    ...
    getWeather(){
      /* 获取天气 */
      $.get("http://wthrcdn.etouch.cn/weather_mini?city=房县", function (data) {
        var info = data.data;
