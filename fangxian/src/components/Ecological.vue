    ...
    paintMap() {
      //console.log('paint map')
			...
			var map = new qq.maps.Map(document.getElementById("map-container"), {
				center: new qq.maps.LatLng(31.882776,110.960030),      // 地图的中心地理坐标。
				zoom: 13,	                                            // 地图的中心地理坐标。
    	...
    	/* 第一个点    土壤 */
			...
			var marker = new qq.maps.Marker({
				position: new qq.maps.LatLng(31.882776,110.960030), 
				map: map,
      ...
      markerIcon1 = new qq.maps.MarkerImage(
	    ...
	    var anchor = new qq.maps.Point(0, 39),
		  ...
		  /* 第三个点    气象 */
			...
			/* 第四个点    水文 */
			var marker = new qq.maps.Marker({
  		      position: new qq.maps.LatLng(31.863402,110.960102),
  		      map: map,
  		    });
  		    var anchor = new qq.maps.Point(0, 39),
					size = new qq.maps.Size(42, 68),
			...
			// 	anchor
			// );
			marker.setIcon(markerIcon1,markerIcon5);
